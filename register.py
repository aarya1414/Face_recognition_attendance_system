...
class register:
    def __init__(self,root):
      ...
      #  self.bg=ImageTk.PhotoImage(file=r"C:\Users\Lenovo\Desktop\face recognition\Images\images.jpg")
     ...
     #   img1=Image.open(r"C:\Users\Lenovo\Desktop\face recognition\Images\reg.png")
     #   img1=img1.resize((450,100),Image.ANTIALIAS)
     #   self.photoimage1=ImageTk.PhotoImage(img1)
     #   lb1img1 = Label(image=self.photoimage1,bg="#F2F2F2")
     #   lb1img1.place(x=300,y=100, width=700,height=900)
        ...
        loginbtn=Button(frame,command=self.return_login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC",cursor="hand2")

...
class face_recognition:
    def __init__(self,root):
        ...
        #bg image
        img=Image.open(r"C:\Users\Lenovo\Desktop\face recognition\Images\face.jpg")
        ...
        title_1b1=Label(self.root,text="FACE RECOGNITION",font=("Franklin Gothic Demi",35,"bold"),fg="#21478a")
        title_1b1.place(x=0,y=40,width=1530,height=45)

        b1_1=Button(self.root,text="FACE RECOGNITION",cursor="hand2",command=self.face_recog,font=("Franklin Gothic Demi",20,"bold"),fg="#4175a6",bg="#ededed")
        b1_1.place(x=565,y=730,width=400,height=40)
#====================Attendeance Marked===================
    ...
    def face_recog(self):
        ...
        clf.read(r"C:\Users\Lenovo\Desktop\face recognition\classifier.xml")
